...
# 💻 Tech Stack:
[![Tech Skills](https://skillicons.dev/icons?i=c,cs,cpp,dart,html,java,js,latex,md,py,solidity,aws,azure,firebase,gcp,fastapi,flutter,nodejs,opencv,qt,apache,nginx,mongodb,mysql,postgres,sqlite,keras,matplotlib,numpy,pandas,scikit-learn,tensorflow,git,notion,postman,arduino,raspberrypi,swagger,trello)](https://skillicons.dev)    
