...
# 💻 Tech Stack:
[![Tech Skills](https://skillicons.dev/icons?i=c,cs,cpp,dart,html,java,js,latex,md,py,solidity,aws,azure,firebase,gcp,fastapi,flutter,nodejs,opencv,qt,nginx,mongodb,mysql,postgres,sqlite,tensorflow,git,notion,postman,arduino,raspberrypi)](https://skillicons.dev)    
